...
正常情况应该是如下图所示（没有任何内容也没关系），如果提示“命令未找到”，则说明你没有安装 Node.js。你需要按 [此教程](https://www.runoob.com/nodejs/nodejs-install-setup.html) 安装运行 Claude Code、Codex 等 CLI 所需的环境。
...
1. 如果你还需要使用 Grok Build，请根据系统执行对应的官方安装命令
