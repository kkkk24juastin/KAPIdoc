...
1. **检查支付是否成功**：确认支付页面显示支付成功
2. **等待几分钟**：有时系统处理需要一定时间
3. **刷新页面**：有时候页面缓存可能导致余额显示不及时
4. **查看消费记录**：在「账单」或「消费记录」中确认是否有充值记录
5. **联系客服**：如果以上方法都无法解决，请联系客服并提供支付凭证
...
1. 登录使用站点查看当前余额
2. 如果余额为 0 或不足，可以通过以下方式充值：
   - **在线充值**：在「钱包管理」页面选择「在线充值」
   - **兑换码充值**：前往 [购买地址](https://pay.ldxp.cn/shop/kkkk24) 购买兑换码后充值
3. 充值完成后重试
